...
class StringChange {
    ...
    static public function keyGen() {
        return str_replace('-','',substr(StringChange::uuid(),1,-1));
    }
    ...
    static public function buildFormatRand($format,$number=1) {
        ...
        for($j=0; $j<$number; $j++) {
            ...
            for($i=0; $i<$length; $i++) {
                ...
                switch($char){
                    case "*"://字母和数字混合
                        $strtemp   .= StringChange::randString(1);
                        break;
                    case "#"://数字
                        $strtemp  .= StringChange::randString(1,1);
                        break;
                    case "$"://大写字母
                        $strtemp .=  StringChange::randString(1,2);
                        break;
                    default://其他格式均不转换
                        $strtemp .=   $char;
                        break;
